# Autogenerated wrapper script for LibRaw_jll for x86_64-apple-darwin
...
JLLWrappers.@declare_library_product(libraw, "@rpath/libraw.20.dylib")
JLLWrappers.@declare_library_product(libraw_r, "@rpath/libraw_r.20.dylib")
